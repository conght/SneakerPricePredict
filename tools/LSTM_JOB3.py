...
def build_lr_model():  #layers [1,50,100,1]
    model = Sequential()
...
def LRPredict(X, weights='W.LR.hdf5'):
...
if __name__=='__main__':
    ...
    print(float(1112*(point_by_point_predictions[0]+1)))
    day01 = []
    day01.append(float(1)/float(41))
    day01.append(float(1112*(point_by_point_predictions[0]+1))/float(1000))
    day01.append(float(1)/float(28))     #black
    day01 = np.array([day01])
    print(day01.shape)

    new_color_point_by_point_predictions = LRPredict(X=day01)
    print((new_color_point_by_point_predictions+1)*1000)
